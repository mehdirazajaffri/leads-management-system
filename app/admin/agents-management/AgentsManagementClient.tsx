      ...
      {showCreate && (
        <div className="card">
          <div className="card-header">
            ...
            <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Agents can log in and manage their assigned leads.</p>
          </div>
      ...
      {(() => {
        const columns: DataTableColumn<Agent>[] = [
          ...
          },
          {
            ...
            cell: (r) => <span className="text-slate-600 dark:text-slate-400">{r.email}</span>,
          },
          {
            id: 'assigned',
            header: 'ASSIGNED',
